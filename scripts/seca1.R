...
#STEP 1c
pure_S.p<-capscale(spp.t ~  PCNM_1 + Condition (Elev +  P + H_Al + K + N + Sol + Silt + `Elev^2` + `N^2` + `AF^2` + `K^2` + X + Y), distance= "horn", fts.exp)                          # linhas de código para rodar o modelo referente a contribuiçao pura do espaço refinado
